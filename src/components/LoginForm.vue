<template>
  <div class="login-form-container">
    ...
    <!--
      Usamos @submit.prevent en el formulario para llamar a nuestro método
      handleLogin en lugar de la acción por defecto del navegador (recargar página).
    -->
...
const isError = ref<boolean>(false); // Para estilizar el mensaje de feedback si es un error
